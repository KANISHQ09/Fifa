...
- Documentation markdown files (`*.md`) have been removed from version control and are kept locally only.
- Run `npm install` and `npm run dev` as described in the **Running the Project Locally** section.
